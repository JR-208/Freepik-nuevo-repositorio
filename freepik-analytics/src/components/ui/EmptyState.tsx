...
export function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      ...
      <h2 className="text-xl font-600 text-text-primary mb-2">No data yet</h2>
      <p className="text-sm text-text-secondary mb-8 max-w-sm">
        Upload your Freepik contributor CSV exports to start analyzing your performance data.
      </p>
      <Link
        href="/upload"
